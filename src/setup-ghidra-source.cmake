...
set(ghidra_patches
  ...
  "${CMAKE_CURRENT_LIST_DIR}/patches/stable/0007-sleigh-cannot-decode-cortex-m33-co-processor-instructions-8391.patch"
)
...
if("${sleigh_RELEASE_TYPE}" STREQUAL "HEAD")
  ...
  set(ghidra_patches
    ...
    "${CMAKE_CURRENT_LIST_DIR}/patches/HEAD/0007-sleigh-cannot-decode-cortex-m33-co-processor-instructions-8391.patch"
  )
